  ...
  return (
    <DetailWrapper>
      ...
      <RightContainer>
        ...
        <DonateSection>
          <Input value={amount} onChange={(e) => setAmount(e.target.value)}  placeholder="Enter Amount To Donate" />
        ...
        <FundsData>
          ...
          <FundText className="temp">{Data.requiredAmount} Matic</FundText>
          <Funds>
            <FundText>Received Amount</FundText>
            
          </Funds>
          <FundText className="temp">{Data.receivedAmount} Matic</FundText>
        </FundsData>
        <Donated>
          <LiveDonation>
            ...
            {DonationsData.map((e) => {
              ...
              <Donation key={e.timestamp}>
                ...
                <DonationData>{new Date().toLocaleDateString()}</DonationData>
